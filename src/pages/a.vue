...
<div class="ui-message-show mb60">
      <div class="ui-msg-col ui-msg-pd40">
        <span @click='openBox3()'>点击打开 Message Box</span>
      </div>
      <div class="ui-meta" v-if="isShow">
        <div class="ui-description">
          <p>以上三个方法都是对
...
<div class="ui-message-show mb60">
      <div class="ui-msg-col ui-msg-pd40">
        <span @click='openBox4()'>点击打开 Message Box</span>
      </div>
      <div class="ui-meta" v-if="isShow">
        <div class="ui-description">
          <p>以上三个方法都是对
    ...
    <div class="rob-alert-cover" v-if="isVisible1">
  ...
  <div class="rob-alert-cover" v-if="isVisible3">
      <div  class="rob-alert rob-alert-dismissible" role="alert ">
              <button type="button" class="rob-alert-close" data-dismiss="rob-alert" aria-label="Close" @click="openBox3()">
                  <span aria-hidden="true">×</span>
              </button>
              <div class="rob-alert-content">
                  <!--qb-icon-active  保存成功-->
           ...
           <div class="rob-alert-cover" v-if="isVisible4">
           ...
           <div class="rob-alert-cover" v-if="isVisible5">

           </div>



           <div class="rob-alert-cover" v-if="isVisible6">

           </div>


           <div class="rob-alert-cover" v-if="isVisible7">

           </div>


           <div class="rob-alert-cover" v-if="isVisible8">
...
export default {
  ...
  methods: {
    ...
    openBox8 () {
      this.isVisible8 = !this.isVisible8
    }
  }
}
</script>
